...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="HOLMES Full SFT")
    ...
    parser.add_argument("--wandb_project", type=str, default="HOLMES-Full-SFT", help="Weights & Biases project name")
    ...
    args.wandb_run_name = f"HOLMES-Full-SFT-Epoch-{args.epochs}-BatchSize-{args.batch_size}-LearningRate-{args.learning_rate}"
