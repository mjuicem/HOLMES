...
class PretrainDataset(Dataset):
    ...
    def __getitem__(self, index: int):
        ...
        input_id = numpy.array(input_id)
        X = numpy.array(input_id[:-1]).astype(numpy.int64)
        Y = numpy.array(input_id[1:]).astype(numpy.int64)
        loss_mask = numpy.array(loss_mask[1:]).astype(numpy.int64)
